    ...
    >
      ...
      >
        <div class="flex items-center">
          <img
            class="rounded-full"
            src="https://yt3.ggpht.com/yti/AGOGRCrDu9kiW5oPzcrcpsDxd_48rCTVngPlZGbKRwuWkA=s88-c-k-c0x00ffffff-no-rj"
            width="27"
          />

          <div class="text-white text-[14px] ml-1.5 font-semiblod">
            HarmonyWave
          </div>
          <ChevronDown
            v-if="!openMenu"
      ...
      <span
        v-if="openMenu"
        class="fixed w-[190px] bg-[#282828] shadow-2xl z-50 rounded-sm top-[52px] right-[35px] p-1 cursour-pointer"
      >
